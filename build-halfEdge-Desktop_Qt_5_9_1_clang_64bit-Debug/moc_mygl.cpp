...
QT_MOC_LITERAL(4, 21, 12), // "sendSkeleton"
QT_MOC_LITERAL(5, 34, 9), // "Skeleton*"
QT_MOC_LITERAL(6, 44, 14), // "sendSelectedHE"
QT_MOC_LITERAL(7, 59, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(8, 76, 18), // "sendSelectedVertex"
QT_MOC_LITERAL(9, 95, 16) // "sendSelectedFace"

    },
    "MyGL\0sendMesh\0\0Mesh*\0sendSkeleton\0"
    "Skeleton*\0sendSelectedHE\0QListWidgetItem*\0"
    "sendSelectedVertex\0sendSelectedFace"
};
...
void MyGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendSelectedHE((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->sendSelectedVertex((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 4: _t->sendSelectedFace((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sendSelectedHE)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MyGL::*_t)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sendSelectedVertex)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (MyGL::*_t)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sendSelectedFace)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 2
void MyGL::sendSelectedHE(QListWidgetItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void MyGL::sendSelectedVertex(QListWidgetItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void MyGL::sendSelectedFace(QListWidgetItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
